...
static const struct freq_tbl  ftbl_gpu_cc_gx_gfx3d_clk_src_sdm845_v2[] = {
	...
	F(415000000, P_CRC_DIV,  1, 0, 0),
	F(520000000, P_CRC_DIV,  1, 0, 0),
	F(656000000, P_CRC_DIV,  1, 0, 0),
	F(765000000, P_CRC_DIV,  1, 0, 0),
...
static void gpu_cc_gfx_sdm845_fixup_sdm845v2(void)
{
	...
	gpu_cc_gx_gfx3d_clk_src.clkr.hw.init->rate_max[VDD_GX_HIGH] =
		656000000;
	gpu_cc_gx_gfx3d_clk_src.clkr.hw.init->rate_max[VDD_GX_HIGH_L1] = 765000000;
